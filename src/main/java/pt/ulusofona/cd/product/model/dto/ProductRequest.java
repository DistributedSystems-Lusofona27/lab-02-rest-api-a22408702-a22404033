...
public record ProductRequest(
        ...
        @Schema(description = "Longer description", example = "87-key, brown switches")
        ...
        @Schema(description = "Unit price", example = "89.90")
        ...
        @Schema(description = "ISO currency code, only EUR is accepted", example = "EUR")
        @Pattern(regexp = "^EUR$", message = "currency must be EUR")
        String currency,

        @Schema(description = "Units in stock", example = "25")
